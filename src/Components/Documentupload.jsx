...
function FileUpload() {
  ...
  return (
    <div className="bg-gray-500 h-screen w-screen  py-2 sm:px-8 md:px-16 sm:py-8">
      ...
      <main className="container mx-auto max-w-screen-lg h-full">
        ...
        >
          ...
          <footer className="flex justify-end px-8 pb-8 pt-4">
            <button id="submit" className="rounded-sm px-3 py-1 bg-blue-700 hover:bg-blue-500 text-white focus:shadow-outline focus:outline-none" onClick={submitFiles}>
              Upload now
            </button>
